...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        None, "crypt", "sets", ["first_print_set_id"], ["id"], ondelete="SET NULL"
    )
    ...
    op.create_foreign_key(
        None, "library", "sets", ["first_print_set_id"], ["id"], ondelete="SET NULL"
    )
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(None, "library", type_="foreignkey")  # type: ignore
    op.drop_index(op.f("ix_library_first_print_set_id"), table_name="library")
    op.drop_column("library", "first_print_set_id")
    op.drop_constraint(None, "crypt", type_="foreignkey")  # type: ignore
